...
x_train, x_test, y_train, y_test = train_test_split(data_one, labels1, test_size=0.2, shuffle=True, random_state=10, stratify=labels1)
x_train2, x_test2, y_train2, y_test2 = train_test_split(data_two, labels2, test_size=0.2, shuffle=True, random_state=10)
